...
const commands = [
  ...
  ["npm", ["run", "maintainer:pack"], clonePath],
  ["npm", ["run", "maintainer:pack:json"], clonePath],
  ["npm", ["run", "external:preflight"], clonePath],
  ["npm", ["run", "external:preflight:json"], clonePath],
  ["npm", ["run", "roadmap:next"], clonePath],
  ["npm", ["run", "roadmap:next:json"], clonePath],
  ...
  ["npm", ["run", "bws:acceptance:json"], clonePath],
  ...
  ["npm", ["run", "auth-hub:xhs-adapter:print"], clonePath],
  ["npm", ["run", "auth-hub:xhs-adapter:json", "--", "--print"], clonePath],
  ["npm", ["run", "auth-hub:private-bundle:print"], clonePath],
  ["npm", ["run", "auth-hub:private-bundle:json", "--", "--print"], clonePath],
